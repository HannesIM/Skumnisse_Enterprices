...
<div class="php">
    ...
    echo "<div class='backbutton'><a href='min_profilside.php'>Tilbake til profilen din</a></div>";
    include "azure.php";
        ...
        echo "<div class='innlegbilde'>";
            echo "<div class='row'>";
                ...
                while($rad = $resultat->fetch_assoc() ) { # loop gjennom alle brukere
                    ...
                    echo "<a href='min_ettbilde.php?media_id=$idmedia&idbruker=$id_link'><img class='bilder'src='img/$media_navn' width='200' height'200'></a>";
                    echo "</div>"; 
                }
            echo "</div>";
            ?>
