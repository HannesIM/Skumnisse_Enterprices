...
<head>
    ...
    <title>Hallo, <?php echo "$brukernavn"; ?></title>
...
<div class="php">
    <?php
        ...
        echo "<br><h1>@$brukernavn</h1>";
            ...
            echo "</div>";
            echo "<br>";
            echo "<a href='min_bildevisning.php'> Se alle bilder </a>";
            echo "<div class='innlegbilde'>";
                echo "<div class='row'>";
                    ...
                    while($rad = $resultat->fetch_assoc() ) { # loop gjennom alle brukere
                        ...
                        echo "<img class='bilder'src='img/$media_navn' width='200' height'150' onclick='myFunction(this);''>";
                        echo "</div>"; 
                    }
                echo "</div>";
                ?>
                ...
                <img id="expandedImg" style="width=400 height'300">
